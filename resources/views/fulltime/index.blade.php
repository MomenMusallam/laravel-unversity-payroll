                ...
                <div class="col-lg-3 col-6">
                    <div class="info-box bg-gradient-success">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">{{$user->vacation_num}}/{{$fulltime->number_of_vacations}} day</span>

                            <div class="progress">
{{--                                <div class="progress-bar" style="width: {{ $user->avrg *100}}%"></div>--}}
                            </div>
                            <span class="progress-description">
                  YOU taked {{round($user->avrg * 100, 1)}}% vacations
                </span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info">
                        <div class="inner">
                            @if($fulltime->payment_method == 'transfer')
                    ...
                    <div class="card card-widget widget-user-2">
                        ...
                        <div class="card-footer p-0">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="#" class="nav-link">
                                        Specialization <span class="float-right badge bg-info">{{$fulltime->specialization}}</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="#" class="nav-link">
                                ...
                                <li class="nav-item">
                                    <a href="#" class="nav-link">
                                        Salary <span class="float-right badge bg-danger">{{$fulltime->salary_amount}}</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
